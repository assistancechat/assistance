...
PROMPT = textwrap.dedent(
    r"""
        ...
        format that would be useful for fulfilling your task. The functions
        that will be created for these docstrings need to be able to be
        run without access to the internet within a Python WASI sandbox.
