        ...
        <div className='px-6 pt-10 pb-24 sm:pb-32 lg:col-span-5 lg:px-0 lg:pb-56 '>
          <div className='mx-auto space-y-12 max-w-2xl lg:mx-0'>
            ...
            <button
              ...
              className='inline-flex items-center rounded-md border uppercase border-transparent bg-orange-400 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
            >
              <ArrowDownCircleIcon
