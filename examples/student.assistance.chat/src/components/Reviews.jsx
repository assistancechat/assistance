...
import CounsellingPhoto1 from '../images/counsellingphoto1.png'
import CounsellingProfile1 from '../images/counsellingprofile1.png'
import CounsellingProfile2 from '../images/counsellingprofile2.png'
import CounsellingProfile3 from '../images/counsellingprofile3.png'
...
export default function Reviews(props) {
  return (
    <div id="Reviews" className='flex flex-wrap w-screen bg-white p-4 space-x-6'>
        <div className='flex flex-wrap justify-center items-center lg:w-1/3 space-y-6'>
          ...
          <button
            ...
            >
              <a href={reviewsData.ChatButton.href} className='inline-flex h-max w-max space-x-2'>
