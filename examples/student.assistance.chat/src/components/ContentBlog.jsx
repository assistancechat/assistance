    ...
    <div className="overflow-hidden bg-white">
      <div className="relative mx-auto max-w-7xl py-16 px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-prose text-base lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-8">
          <div>
            <h2 className="text-lg font-semibold text-orange-400">{props.contentType}</h2>
            <h3 className="mt-2 text-3xl font-bold leading-8 tracking-tight text-gray-800 sm:text-4xl">{props.Heading}</h3>
          </div>
        </div>
